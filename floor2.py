...
if __name__ == '__main__':
    Point(id=20, name='계단2', floor=2, locationX=0, locationY=1, locationZ=0).save()
    ...
    Point(206, 'PC 실습실2', 2, -15, 1, 5).save()
    Point(207, '세미나실 I', 2, -20, 1, 5).save()
    Point(208, '창고', 2, -25, 1, 5).save()
    Point(209, '지역선도대학 육성사업 사무실', 2, -30, 1, -5).save()
    Point(210, '주영관 교수', 2, -25, 1, -5).save()
    Point(211, '산학협력실', 2, -20, 1, -5).save()
    Point(212, '박명호 교수', 2, -15, 1, -5).save()
    Point(213, '초빙교수실 지역선도대학', 2, -12.5, 1, -5).save()
    Point(214, '문현주 교수', 2, -10, 1, -5).save()
    Point(215, '스마트팩토리 실습실', 2, -7.5, 1, -5).save()
    Point(216, '강재구 교수', 2, -5, 1, -5).save()
    Point(217, '소프트웨어학과 학과사무실', 2, 10, 1, -5).save()
    Point(218, '', 2, 12.5, 1, -5).save()
    Point(219, '교양컴퓨터사무실', 2, 15, 1, -5).save()
    Point(220, '교육 준비실 2', 2, 17.5, 1, -5).save()
    Point(221, '교육사업지원실 3', 2, 22.5, 1, -5).save()
    Point(222, '대학원 강의실', 2, 27, 1, -5).save()
    Point(223, '학부생 스터디룸', 2, 0, 1, 5).save()

    
    connectMarketAndPoint(20, 26, 27) # 에스컬레이터
